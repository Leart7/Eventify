        ...
        searchParams.get("Online") === null && (
          ...
          >
            ...
            <Marker
              ...
              icon={
                state.length !== 0 &&
                markerRef?.current?._latlng.lat === state[0] &&
                markerRef?.current?._latlng.lng === state[1]
                  ? largerIcon
                  : customIcon
              }
              ref={markerRef}
              eventHandlers={{
                mouseover: () => {
                  markerRef.current.setIcon(largerIcon);
                },
                mouseout: () => {
            ...
            <Marker
              ...
              icon={
                state.length !== 0 &&
                secondMarkerRef?.current?._latlng.lat === state[0] &&
                secondMarkerRef?.current?._latlng.lng === state[1]
                  ? largerIcon
                  : customIcon
              }
              ref={secondMarkerRef}
              eventHandlers={{
                mouseover: () => {
                  secondMarkerRef.current.setIcon(largerIcon);
                },
                mouseout: () => {
                  secondMarkerRef.current.setIcon(customIcon);
                },
              }}
            />
