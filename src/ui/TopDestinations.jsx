...
export default function TopDestinations() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#f8f7fa] pb-[40px] pt-[80px] w-full">
      <section
      ...
      >
        ...
        <div className="flex gap-8 overflow-x-scroll" ref={contentRef}>
          <aside>
            <div className="group relative h-[180px] w-[280px] cursor-pointer overflow-hidden rounded-t-[40px] sm:h-[208px] sm:w-[336px]">
              <img
      ...
      <div
        className="absolute bottom-0 xl:right-[5.5em]  right-0 top-0 z-20 h-full w-2 bg-[#f8f7fa]"
